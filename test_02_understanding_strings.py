...
def test_triple_quoted_strings_can_span_lines():
    ...
    assert 15 == len(string)# because of the spaces
...
def test_string_combine():
    ...
    assert  bye[0:7] + hello[5:11]  == "Goodbye World"
...
def test_string_membership():
    ...
    assert True == ('a' in 'apple') #yes , comparisions have higher preceedence than membership operators
    assert True == ('app' in 'apple')# the expression that has to be evaluated first is put in the parantheses


three_things_i_learnt = """
-various types of strings and their various denotions and also raw and unicode strings
-string functions like indexing,slicing,formatting,membership,concatenation,repetition and combination and also some properties of strings
-operator precedence and how to resolve such issues
"""
