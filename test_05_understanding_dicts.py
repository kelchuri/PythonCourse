...
-properties of dictionaries and also extracting values of dictionary using keys
-dictionaries can store tuples as keys but not lists as they are unhashable
"""
