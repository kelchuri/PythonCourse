...
-definition and declaration function using 'def'
-how the execution of function goes on (creating a local symbol table)
-parameters are called in the "call by object reference" fashion
"""
