...
def test_find_builtins_that_work_on_iterables():
    funcs = [all, any, filter, frozenset, list, map, min, next, reduce, set, sorted, sum, tuple, zip]
    assert 14 == len(funcs)


three_things_i_learnt = """
-different types of iterators and their implementation
-use of next() method to go to the next element
