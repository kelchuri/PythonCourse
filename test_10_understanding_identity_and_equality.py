...
-usage of identity and equality
-differences between identity and equality
-small integers behave differently as from -5 to 256 are cached and when we refer to them we get a reference to the existing object unlike in case of large numbers(257 and above) where a new object is created
"""
