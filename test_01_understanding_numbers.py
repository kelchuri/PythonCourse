...
-the meaning and usage of attributes like __name__,__doc__
-use of type and int functions
-difference in the syntax and presentation of python from other object oriented languages
"""
