...
def test_package_basic_import():
    ...
    print package1.module1.__doc__ # None as nothing is given as documentation
...
def test_package_import_failure():
    ...
    why_it_failed = "beacuse it doesnt contain __init__.py file as it is necessary to make python treat directories as containg packages"
...
def test_package_sub_packages():
    ...
    print subpackage.m1.__doc__   #None
#import subpackage also imports m1 along with it,['__author__', '__builtins__', '__doc__', '__file__', '__name__', '__package__', '__path__', 'm1']
#hence subpackage.m1 doesnt show up any error
    assert True == ("package1.subpackage.m1" in sys.modules)

three_things_i_learnt = """
-importing packages and required modules
-accessing the packages
-various concepts related to modules
"""
