...
-various control flow structures and syntaxes
-using break and continue in the control flow structures
-various representations of for and the diff between python and other languages
"""
